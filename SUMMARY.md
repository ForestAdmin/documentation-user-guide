...
- [Other project settings](project-settings/other-project-settings/README.md)
  ...
  - [Security tab](project-settings/other-project-settings/security-tab/README.md)
    ...
    - [SCIM integration with Okta](project-settings/other-project-settings/security-tab/scim-integration-with-okta.md)
    - [Manual SCIM integration with Okta](project-settings/other-project-settings/security-tab/manual-scim-integration-with-okta.md)
