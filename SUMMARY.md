...
* [Tutorials](https://docs.forestadmin.com/tutorials)

## Collections

* [Manage your collection settings](collections/manage-your-collection-settings.md)
* [Customize your fields](collections/customize-your-fields/README.md)
...
* [Actions](collections/actions/README.md)
  ...
  * [Using Smart Actions](collections/actions/create-and-manage-smart-actions.md)
* [Workflows](collections/workflows.md)
* [Segments](collections/segments.md)
* [Scopes](collections/scopes.md)
* [Performance](collections/performance.md)
...
* [Using Workspaces](workspaces/using-workspaces/README.md)
  ...
  * [Editing records with field components](workspaces/using-workspaces/editing-records-with-field-components.md)
* [Building a workspace](workspaces/building-a-workspace/README.md)
  ...
  * [Transactions Monitoring & Fraud Management example](workspaces/building-a-workspace/transactions-monitoring-and-fraud-management-example.md)
  * [Fleet Management example](workspaces/building-a-workspace/fleet-management-example.md)

## dashboards

* [Charts](dashboards/charts/README.md)
  * [Create a chart](dashboards/charts/create-a-chart.md)
  * [Display record-specific charts in Analytics](dashboards/charts/analytics.md)
...
* [Security tab](project-settings/security-tab/README.md)
  * [SCIM integration with OneLogin](project-settings/security-tab/scim-integration-with-onelogin.md)
  * [SCIM integration with Okta](project-settings/security-tab/scim-integration-with-okta.md)
  * [Manual SCIM integration with Okta](project-settings/security-tab/manual-scim-integration-with-okta.md)
...
* [Organizations](project-settings/organizations/README.md)
  * [Organization settings](project-settings/organizations/organization-settings.md)
    * [Configure SSO with AWS IAM](project-settings/organizations/sso-guides/sso-with-aws.md)
